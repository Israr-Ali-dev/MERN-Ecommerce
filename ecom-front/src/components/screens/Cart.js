...
import { getCart, updateItem } from '../core/cartHelper';
...
function Cart() {
    ...
    return (
      <Fragment>
        <main className='main-content' id='MainContent'>
          <div className='page-narrow page-content'>
            <div className='grid'>
              <div className='grid__item'>
                <header className='section-header text-center'>
                  <h1 className='section-header__title'>Cart</h1>
                </header>
                <div className='cart__item cart__item--headers small--hide'>
                  <div className='cart__item--details'>
                    <div className='cart__item--qty'>Quantity</div>
                    <div className='cart__item--price text-right'>Total</div>
                  </div>
                </div>
                {items.map((product, i) => {
                  return (
                    <Fragment>
                      <div key={i} className='cart__item'>
                        <div className='cart__item--image' data-aos>
                          <Link
                            ...
                            <img
                              ...
                              className='cart-img'
                              alt='Custom Album Art iPhone Case - iPhone 12 | 12 Pro / Black Impact'
                            />
                          </Link>
                        </div>
                        <div className='cart__item--details'>
                          <div className='cart__item--name'>
                            <Link href='#' className='cart__product-name'>
                              {product.name}
                            </Link>
                            <p className='cart__product-meta'>
                              iPhone 12 | 12 Pro / Black Impact
                            </p>
                          </div>
                          <div className='cart__item--qty'>
                            <label for='' className='visually-hidden'>
                              Quantity
                            </label>
                          ...
                          <div className='cart__item--price text-right'>
                            <span className='cart__price'>
                              <div
                                ...
                                data-id='33193848012853:91f002e60bc565069bbe1295e6719727'>
                ...
                <div className='cart__footer'>
                  <div className='grid'>
                    <div className='grid__item medium-up--one-half text-center medium-up--text-right medium-up--push-one-half'>
                      <div className='grid grid--full'>
                        <div className='grid__item one-half medium-up--text-right small--text-left'>
                          <p className='cart__subtotal'>Subtotal</p>
                        </div>
                        <div className='grid__item one-half small--text-right'>
                          <p>
                            $
                            {items
                              ? items.reduce((current, product) => {
                                  return (
                                    current + product.count * product.price
                                  );
                                }, 0)
                              : null}
                          </p>
                      ...
                      <p className='ajaxcart__note'>
                        Free Shipping Worldwide
                        <br />
                      </p>
                      <p className='ajaxcart__note ajaxcart__note--terms'>
                        <input
                          type='checkbox'
                          checked={terms}
                          onClick={() => {
                        ...
                        <label for='CartPageAgree'>
                          I confirm I have selected the correct phone model.
                        </label>
                      </p>
                      <div className='cart__checkout-wrapper'>
                        <button
                          type='submit'
                          name='update'
                          className='btn btn--no-animate cart__update visually-hidden'>
                          Update cart
                        </button>
                        <button
                          className='btn'
                        ...
                        <div className='additional-checkout-buttons'>
                          <div
                            ...
                            <div>
                              <div className='shopify-cleanslate'>
                                <div
                                  ...
                                  className='VoW3UuJKYxZJHMpUkDNUv'
                                  aria-hidden='true'>
                                  <svg
                              ...
                              <div className='shopify-cleanslate'>
                                <div className='_38ksdFFHosgt4hh6EjDuLm _3mgStMpRn3ZERlUsxma1Bc'>
                                  <div
                                    className='_1mqqPYZtCQtz5_i0b-po4l'
                                    data-shopify-buttoncontainer='true'>
                                    <div
                                      className='_3TUeZPsTWjDxakSmeDcA4D'
                                      data-testid='grid-cell'>
                                      <div
                                        role='button'
                                        tabindex='0'
                                        className='_1LP9NPTft85QosIXd3_zOV _3G6VJhJYno-AX3-X38f1TA _2zarRkvJ2j83NID3Q3t0Ix _3xia0N5Q9Mk6-VTLoOX95a'
                                        data-testid='ShopifyPay-button'>
                                        <span className='_11GJAaBiShTVGYuXppoYvE'>
                                          ShopPay
                                        </span>
                                        <span className='bp01pMHFBVS3SyhYtJKk'>
                                          <svg
                                            preserveAspectRatio='xMidYMid'
                                            className='h7yAG5cgdBp_GhZjXmVIA'
                                            style={{
                                              height: '24px',
                                              width: '82px',
                                            }}>
                                            <use href='#shopify-svg__payments-shopify-pay-light'></use>
                                          </svg>
                                        </span>
                                      </div>
                                    </div>
                                    <div
                                      ...
                                      <div
                                        role='button'
                                        tabindex='0'
                                        className='_1LP9NPTft85QosIXd3_zOV _3G6VJhJYno-AX3-X38f1TA _2zarRkvJ2j83NID3Q3t0Ix _1GxIZiuIYnVTrkxMSSrber'
                                        ...
                                        <span className='bp01pMHFBVS3SyhYtJKk'>
                                          <svg
                                            ...
                                            <use href='#shopify-svg__payments-google-pay-light'></use>
                                          </svg>
                                        </span>
                                      </div>
                                    </div>
                                    <div
                                      ...
                                      data-testid='grid-cell'>
                                      <iframe
                                        className='_1qHzu06EhANVVG3mlfU6Ho paypalLight _1n3zwJXRK30xbubjNiZsKV'
                                        title='Checkout with PayPal'
                                        __idm_frm__='874'></iframe>
                                    </div>
                                  </div>
                                </div>
                              </div>
  ...
  return (
    <Fragment>
      <Layout childComponent={cartPage()} />
    </Fragment>
  );
}
